...
MODEL                = Assignment_1_17052017
MODULES              = 
PRODUCT              = $(RELATIVE_PATH_TO_ANCHOR)/Assignment_1_17052017.exe
MAKEFILE             = Assignment_1_17052017.mk
...
MASTER_ANCHOR_DIR    = 
START_DIR            = C:/Users/mstecca/SURFDR~1/Marco/SIMULA~1/CONVER~1/ANALYT~1/MATLAB~1/FREQUE~1
S_FUNCTIONS_LIB      = 
NUMST                = 5
NCSTATES             = 75
BUILDARGS            = 
...
MODELLIB                  = Assignment_1_17052017lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = Assignment_1_17052017_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/accel/Assignment_1_17052017 \
...
%.obj : $(START_DIR)/slprj/accel/Assignment_1_17052017/%.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $<
